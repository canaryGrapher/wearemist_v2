...
function WorkCard(props) {
      ...
      const githubLink = props.github ? <a href={props.github}><i className="fab fa-github mx-10" style={{ fontSize: '3rem', color: "#6e5494" }}></i></a> : null
      const linkedinLink = props.linkedin ? <a href={props.linkedin}><i className="fab fa-linkedin mx-10" style={{ fontSize: '3rem', color: '#0e76a8' }}></i></a> : null
      return (
